...
//#define MQ135_DEFAULTRO 89168
//#define MQ135_DEFAULTRO 44584
//#define MQ135_DEFAULTRO 40967
//#define MQ135_DEFAULTRO 99458
//#define MQ135_DEFAULTRO 4584
...
void setup()  
{
  ...
  Serial.println("AIQ Sensor MQ135 v1.0");
...
{    
  ...
  Serial.println(valr);
  //uint16_t val =  ((float)22000.0*(1023-valr)/valr);
   uint16_t val =  ((float)22000.0*(1023-valr)/valr); 
  // uint16_t val =  ( ((float)RL_VALUE*(4095-ra)/raw_adc))
  Serial.println(val);
  mq135_ro = mq135_getro(val, MQ135_DEFAULTPPM);
  //convert to ppm (using default ro)
  valAIQ = mq135_getppm(val, MQ135_DEFAULTRO);

  int t = MQGetPercentage(val,MQ135_DEFAULTRO,CO2Curve);
